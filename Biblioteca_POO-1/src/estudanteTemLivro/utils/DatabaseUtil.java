 ...
 */
package estudanteTemLivro.utils;
...
public class DatabaseUtil {
    ...
    public void createUsuarioTemLivroTable() {
        try {
            ...
            this.stmt.executeUpdate("CREATE TABLE usuario_tem_livro (id INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1) PRIMARY KEY,"+ //executeUpdate -> executa comandos no BD
                                    "id_livro INTEGER, " +
                                    "id_usuario INTEGER, " +
            ...
            this.stmt.executeUpdate("ALTER TABLE usuario_tem_livro ALTER COLUMN id_livro SET NULL");
            this.stmt.close();
            this.conn.close();
